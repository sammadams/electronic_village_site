<?php
	...
	$topTitle = "Add Presentation (Classics)";
...
?>
	...
	<p align="center"><a href="addClassics.php">Add Another Presentation</a></p>
...
?>
	...
	<script type="text/javascript">
		...
		function savePresForm(n) {
			...
			if(document.getElementById('pres_first_name').value == '') {
				...
				if(!cert) {
					alert('Does this presenter NEED a paper certificate? Please select "Yes" or "No"!');
					return;
				}
			}
	...
	<p align="center"><input type="button" value="Cancel" onClick="window.location.href='listProps_classics.php'"> &nbsp; &nbsp; &nbsp; &nbsp; <input type="button" value="Submit" onClick="checkForm()" ></p>
		<div id="presFormDiv">
